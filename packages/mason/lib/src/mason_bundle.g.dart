...
MasonBundledFile _$MasonBundledFileFromJson(Map json) =>
    $checkedCreate('MasonBundledFile', json, ($checkedConvert) {
...
MasonBundle _$MasonBundleFromJson(Map json) =>
    $checkedCreate('MasonBundle', json, ($checkedConvert) {
      $checkKeys(
        json,
        allowedKeys: const [
          'files',
      ...
      final val = MasonBundle(
        ...
        readme: $checkedConvert(
          ...
          (v) => v == null
              ? null
              : MasonBundledFile.fromJson(Map<String, dynamic>.from(v as Map)),
        ),
